...
WCHAR* target_stream = L"D:\\test\\test.txt:hidden";
...
```cmd
D:\test\alternate_data_stream>dir /r
...
- [NTFS Streams](https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-fscc/c6e988d7-3771-4b86-a6c5-d5b71c4225f9)
...
📄 report.docx (100 KB) — normal, innocent
   └── :stolen_passwords.txt (50 KB) — hidden data
...
└── examples/
    ├── basic_ads.md        # Simple ADS creation
    ├── malware_hiding.md   # Evasion scenarios
    └── forensic_detection.md # How to find hidden streams
```
